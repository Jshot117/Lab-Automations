...
MAX_INTERACTION_COUNT = ((TOTAL_P300_TIPS - END_OF_SHIFT_CLEAN_COUNT * 3) - END_OF_DAY_CLEAN_COUNT) - 1 # at the beginning of the set up the robot uses one tip to fill wells
